...
const toLastNames = people => {
  // Solution code here...
  return people.map(v=>`${v.firstName} ${v.lastName}`);
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((acc,v)=>v.purchasePrice+acc,0);
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.map(v=>v.toString()).reduce((acc,v)=>v.length + acc,0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((acc,v) => acc.concat(v.name),[]);
};
...
const reversedString = (str) => {
  // Solution code here...
  // learned about split from chatgtp
  return str.split('').reduce((acc,v)=> v + acc,'');
};
